...
%% this document is intend to prepare response to the thesis proposal committee
%% however, it is a very generic document template, can be used for general-
%% purpose article by making some tweaks or adding more options in here.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
