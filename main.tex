...
%% is an issue with package dependency, so I included packages in that order.
...
%% may need to define more if some Unicode characters appear somewhere in your thesis
