...
%% depending on the number of advisor/ co-advisors and committee members
%% you have, you can style the placement of this in many different ways.
%% you can include their full (or brief) affiliation to fit all on the page.
%% you can place them side-by-side in a centered environment (STYLE 1)
%% you can place them one after one in a left justified environment (STYLE2)
%% you can style however you want with proper spacing

%%%% Suggested STYLE 2: CENTERED (uncomment following, comment above)
\begin{center}
...
%%%% Suggested STYLE 2: LEFT PLACEMENT
% \begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% TIME AND LOCATION %%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{0.75in}                     % space after committee members and location
\begin{center}
