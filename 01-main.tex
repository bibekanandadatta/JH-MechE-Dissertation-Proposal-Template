...
%%%% level of paragraph-styled environments
...
\def\LOTItemSpacing{3.6 pt}                 % spacing between LOT/LOF items
...
%% use a citation manager program to generate the BibLaTeX file
...
%%%% if you would like to check consistency in the document this is useful
...
%% you can also condense information about each member by removing some affiliation
%% information. you can also have three `minipage` side-by-side in this case.
...
%% add more objectives ( more objectives, advisors more happy :D )
...
%%% add more tasks and subtasks ( advisor won't be happy with one task :( )
